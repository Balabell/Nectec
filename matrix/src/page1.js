        ...
        this.state.listRow.map((item1, index1) => {
            myDataInner.map((item2, index2) => {
                ...
                if (item1 === item2.Level1 && this.state.currentLevel1 === 'ทุกประเภท' && item2.Level1 !== "" && item2.Level2 !== "" && item2.Level3 !== "") {
                    ...
                    else if (this.state.currentLevel2 === 'ทุกประเภท' && this.state.currentLevel3 === item2.Level3 && item2.Direct_Strategy !== "") { // all all ...
                        switch (this.setSplit(item2.Direct_Strategy)) {
                            case 'Y1': this.state.blog[index1][0] = this.state.blog[index1][0] + 1; break;
                            case 'Y2': this.state.blog[index1][1] = this.state.blog[index1][1] + 1; break;
                            case 'Y3': this.state.blog[index1][2] = this.state.blog[index1][2] + 1; break;
                    ...
                    else if (this.state.currentLevel3 === 'ทุกประเภท' && this.state.currentLevel2 === item2.Level2 && item2.Direct_Strategy !== "") { // all ... all
                        switch (this.setSplit(item2.Direct_Strategy)) {
                            case 'Y1': this.state.blog[index1][0] = this.state.blog[index1][0] + 1; break;
                            case 'Y2': this.state.blog[index1][1] = this.state.blog[index1][1] + 1; break;
                            case 'Y3': this.state.blog[index1][2] = this.state.blog[index1][2] + 1; break;
