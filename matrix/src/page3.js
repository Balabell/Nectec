    ...
    constructor() {
        ...
        myDataOuter.map((item) => {
            if (item.Level1 !== "" && item.Level2 !== "" && item.Level3 !== "") {
                this.state.listRowTest.push(item.Level3);
            }
        });
    ...
    setData = () => {
        ...
        this.state.listRow.map((item1, index1) => {
            myDataInner.map((item2, index2) => {
                ...
                if (item1 === item2.Level3 && this.state.currentLevel1 === 'ทุกประเภท' && item2.Level1 !== "" && item2.Level2 !== "" && item2.Level3 !== "") {
                    if (this.state.currentLevel2 === 'ทุกประเภท' && this.state.currentLevel3 === 'ทุกประเภท' && item2.Direct_Strategy !== "") {  // all all all
                    ...
                    else if (this.state.currentLevel2 === 'ทุกประเภท' && item1 === this.state.currentLevel3 && item2.Direct_Strategy !== "") { // all all ...
                        switch (this.setSplit(item2.Direct_Strategy)) {
                            case 'Y1': this.state.blog[index1][0] = this.state.blog[index1][0] + 1; break;
                            case 'Y2': this.state.blog[index1][1] = this.state.blog[index1][1] + 1; break;
                            case 'Y3': this.state.blog[index1][2] = this.state.blog[index1][2] + 1; break;
                    ...
                    else if (this.state.currentLevel3 === 'ทุกประเภท' && item2.Level2 === this.state.currentLevel2 && item2.Direct_Strategy !== "") { // all ... all
                        switch (this.setSplit(item2.Direct_Strategy)) {
                            case 'Y1': this.state.blog[index1][0] = this.state.blog[index1][0] + 1; break;
                            case 'Y2': this.state.blog[index1][1] = this.state.blog[index1][1] + 1; break;
                            case 'Y3': this.state.blog[index1][2] = this.state.blog[index1][2] + 1; break;
                        ...
                        item1 === this.state.currentLevel3 && item2.Level2 === this.state.currentLevel2 &&
                ...
                else if (item1 === item2.Level3 && item2.Level1 === this.state.currentLevel1 && this.state.currentLevel2 === 'ทุกประเภท' && item2.Level1 !== "" && item2.Level2 !== "" && item2.Level3 !== "") {
                    if (this.state.currentLevel3 === 'ทุกประเภท' && item2.Direct_Strategy !== "") {  // ... all all
                        switch (this.setSplit(item2.Direct_Strategy)) {
                            case 'Y1': this.state.blog[index1][0] = this.state.blog[index1][0] + 1; break;
                            case 'Y2': this.state.blog[index1][1] = this.state.blog[index1][1] + 1; break;
                            case 'Y3': this.state.blog[index1][2] = this.state.blog[index1][2] + 1; break;
                        ...
                        item2.Level1 === this.state.currentLevel1 && item1 === this.state.currentLevel3 &&
                        item2.Direct_Strategy !== "") {// ... all ...
                        switch (this.setSplit(item2.Direct_Strategy)) {
                            case 'Y1': this.state.blog[index1][0] = this.state.blog[index1][0] + 1; break;
                            case 'Y2': this.state.blog[index1][1] = this.state.blog[index1][1] + 1; break;
                ...
                else if (item1 === item2.Level3 && this.state.currentLevel3 === 'ทุกประเภท' && item2.Level1 !== "" && item2.Level2 !== "" && item2.Level3 !== "") {
                    if (this.state.currentLevel1 !== 'ทุกประเภท' && this.state.currentLevel2 !== 'ทุกประเภท' &&
                        item2.Level1 === this.state.currentLevel1 && item2.Level2 === this.state.currentLevel2 &&
                        item2.Direct_Strategy !== "") { // ... ... all
                        switch (this.setSplit(item2.Direct_Strategy)) {
                            case 'Y1': this.state.blog[index1][0] = this.state.blog[index1][0] + 1; break;
                            case 'Y2': this.state.blog[index1][1] = this.state.blog[index1][1] + 1; break;
                ...
                else if (item1 === item2.Level3 && this.state.currentLevel1 !== 'ทุกประเภท' && this.state.currentLevel2 !== 'ทุกประเภท' && this.state.currentLevel3 !== 'ทุกประเภท' &&
                    item2.Level1 === this.state.currentLevel1 && item2.Level2 === this.state.currentLevel2 && item1 === this.state.currentLevel3 &&
